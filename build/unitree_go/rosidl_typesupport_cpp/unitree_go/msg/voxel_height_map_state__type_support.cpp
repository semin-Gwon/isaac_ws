...
static const _VoxelHeightMapState_type_support_symbol_names_t _VoxelHeightMapState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unitree_go, msg, VoxelHeightMapState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unitree_go, msg, VoxelHeightMapState)),
  }
};
...
{
  return &::unitree_go::msg::rosidl_typesupport_cpp::VoxelHeightMapState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, unitree_go, msg, VoxelHeightMapState)() {
  return get_message_type_support_handle<unitree_go::msg::VoxelHeightMapState>();
}
