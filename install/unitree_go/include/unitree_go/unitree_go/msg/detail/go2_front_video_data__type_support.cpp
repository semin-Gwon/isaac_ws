...
size_t size_function__Go2FrontVideoData__data(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<uint8_t> *>(untyped_member);
  return member->size();
}

const void * get_const_function__Go2FrontVideoData__data(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__Go2FrontVideoData__data(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__Go2FrontVideoData__data(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint8_t *>(
    get_const_function__Go2FrontVideoData__data(untyped_member, index));
  auto & value = *reinterpret_cast<uint8_t *>(untyped_value);
  value = item;
}

void assign_function__Go2FrontVideoData__data(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint8_t *>(
    get_function__Go2FrontVideoData__data(untyped_member, index));
  const auto & value = *reinterpret_cast<const uint8_t *>(untyped_value);
  item = value;
}

void resize_function__Go2FrontVideoData__data(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<uint8_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Go2FrontVideoData_message_member_array[3] = {
  {
    "time_frame",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_go::msg::Go2FrontVideoData, resolution),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_go::msg::Go2FrontVideoData, data),  // bytes offset in struct
    nullptr,  // default value
    size_function__Go2FrontVideoData__data,  // size() function pointer
    get_const_function__Go2FrontVideoData__data,  // get_const(index) function pointer
    get_function__Go2FrontVideoData__data,  // get(index) function pointer
    fetch_function__Go2FrontVideoData__data,  // fetch(index, &value) function pointer
    assign_function__Go2FrontVideoData__data,  // assign(index, value) function pointer
    resize_function__Go2FrontVideoData__data  // resize(index) function pointer
  }
};
